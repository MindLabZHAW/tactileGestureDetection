...
class create_tensor_dataset_FeatureByTime(Dataset):
    ...
    def read_dataset(self):
        ...
        features_colums = joint0_colums + joint1_colums + joint2_colums + joint3_colums + joint4_colums + joint5_colums + joint6_colums
        # print(features_colums)
        ...
        for window_id, group in grouped:
            ...
            if self.num_classes == 5:
                ...
                print("Wrong Class Number in DataLoader")
            self.data_target.append(label_map.get(label_i, -1))
            # Pick all features (28) using features colums(4 features by 7 joints) and use feature as line index and timestamp as colume index (28 x 28)
            featurebytime_data = group.loc[:,features_colums].values.T
            self.data_input.append(featurebytime_data)
...
if __name__ == '__main__':
    rnndata = create_tensor_dataset_FeatureByTime('/home/weimindeqing/contactInterpretation/tactileGestureDetection/DATA/6_labeled_window_dataset_train123.csv')
    print(rnndata.data_input[1].shape)
    print(rnndata.data_input[1])

...
from Data2Models import create_tensor_dataset_FeatureByTime
...
if __name__ == '__main__':
    ...
    # 1. 加载数据
    # ==========================
    full_train_data = create_tensor_dataset_FeatureByTime(
        main_path + 'DATA/6_labeled_window_dataset_train_post1.csv',
        num_classes=num_classes
    )
    testing_data = create_tensor_dataset_FeatureByTime(
        main_path + 'DATA/6_labeled_window_dataset_test_post1.csv',
        num_classes=num_classes
    )
    ...
    if input('do you want to save the data in trained models? (y/n):') == 'y':
        ...
        output_path = (path_name + network_type + 'FBT' + 

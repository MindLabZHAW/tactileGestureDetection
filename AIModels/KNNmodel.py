...
# Load dataset
data_path = '/home/weimindeqing/contactInterpretation/tactileGestureDetection/DATA/3_labeled_window_dataset_post1.csv'
...
#  Encode labels
label_classes = {"NC":0, "ST":1, "P":2, "G":3, }
...
model_path = folder_path + 'KNN_flatten_post1.pkl'

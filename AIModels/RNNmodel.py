...
# collision = False; localization = False; n_epochs = 15; batch_sccize = 64; num_classes = 5; lr = 0.001
# collision = False; localization = False; n_epochs = 15; batch_scize = 64; num_classes = 5; lr = 0.001
# collision = True; localization = False; n_epochs = 120; batch_size = 64; num_classes = 2; lr = 0.001
# collision = False; localizcation = True; n_epochs = 110; batch_size =64; num_classes = 2; lr = 0.001
...
if __name__ == '__main__':
    ...
    training_data = create_tensor_dataset(main_path + 'DATA/6_labeled_window_dataset_train123.csv', num_classes=num_classes)
    testing_data = create_tensor_dataset(main_path + 'DATA/6_labeled_window_dataset_test123.csv', num_classes=num_classes)
    ...
    # Build the model  
    model= Sequence(network_type, num_classes=num_classes)

...
open another terminal 
	...
	$HOME/miniconda/envs/frankapyenv/bin/python3 ../tactileGestureDetection/frankaRobot/demo_STT3DCNN.py
...
method = 'Freq'
model_path_relative = os.path.join("AIModels/TrainedModels", "STT3DCNN_03_05_2025_18-50-24Pose123ES76Conv4+7.pth") # relative path from AIModels
type_network = 'STT3DCNN'

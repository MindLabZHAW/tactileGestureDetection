...
open another terminal 
	...
	$HOME/miniconda/envs/frankapyenv/bin/python3 ../tactileGestureDetection/frankaRobot/demo_STFT2DCNN.py
...
method = 'Freq'
model_path_relative = os.path.join("AIModels/TrainedModels", "2L3DCNN_03_05_2025_11-56-20Pose123ES58_BoundNone.pth") # relative path from AIModels
type_network = '2L3DCNN'
